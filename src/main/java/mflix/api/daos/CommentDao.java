...
public class CommentDao extends AbstractMFlixDao {
    ...
    public Comment addComment(Comment comment) {
        ...
        return getComment(result.getInsertedId().asObjectId().getValue().toHexString());
    }
    ...
    public boolean updateComment(String commentId, String text, String email) {
        ...
        if(comment == null) {
            throw  new IncorrectDaoOperation("Incorrect commentId");
        }
//
//        List<Bson> updates = new ArrayList<>();
//        updates.add(Updates.set("text", text));
//        updates.add(Updates.set("email", email));
    ...
    public boolean deleteComment(String commentId, String email) {
        ...
        try {
            Comment comment = commentCollection.findOneAndDelete(
                    Filters.and(
